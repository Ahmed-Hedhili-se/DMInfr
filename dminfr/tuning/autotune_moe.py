...
from dminfr.engine.fused_moe_triton import (
    fused_moe,
...
#     These match your SMALL_CFG / actual inference loop in benchmarks/time_fraction.py
# ═══════════════════════════════════════════════════════════════════════════════
MODEL_SHAPES = {
...
# Server-side batching (dminfr/serving/server.py, BATCH_MAX_SIZE=64) pushes M as high as
...
def verify_correctness(E, N, K, top_k, config_under_test, reference_config):
    ...
    import dminfr.engine.fused_moe_triton as _ft
...
def main():
    ...
    if args.output is None:
        ...
        from dminfr.engine.fused_moe_triton import _device_tag
